...
export const AccountsApiAxiosParamCreator = function (
  ...
  return {
     ...
     */
    accountsKakaoCallbackList: async (
      options: any = {}
    ): Promise<RequestArgs> => {
     ...
     * @throws {RequiredError}
     */
    accountsKakaoLoginFinishCreate: async (
      data: SocialLogin,
      options: any = {}
    ): Promise<RequestArgs> => {
...
export const AccountsApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async accountsKakaoCallbackList(
      options?: any
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.accountsKakaoCallbackList(options);
     ...
     * @throws {RequiredError}
     */
    async accountsKakaoLoginFinishCreate(
      data: SocialLogin,
      options?: any
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<SocialLogin>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.accountsKakaoLoginFinishCreate(
          data,
          options
        );
      return createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async accountsKakaoLoginList(
      options?: any
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.accountsKakaoLoginList(options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
...
export const AccountsApiFactory = function (
  ...
  return {
    ...
    accountsKakaoCallbackList(options?: any): AxiosPromise<void> {
      return localVarFp
        .accountsKakaoCallbackList(options)
     ...
     * @throws {RequiredError}
     */
    accountsKakaoLoginFinishCreate(
      data: SocialLogin,
      options?: any
    ): AxiosPromise<SocialLogin> {
      return localVarFp
        .accountsKakaoLoginFinishCreate(data, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    accountsKakaoLoginList(options?: any): AxiosPromise<void> {
      return localVarFp
        .accountsKakaoLoginList(options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export const UsersApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    usersProfilesClubsCreate: async (
      profile: string,
      user: string,
      data: InlineObject,
      options: any = {}
     ...
     * @throws {RequiredError}
     */
    usersProfilesEverytimeCreate: async (
      profile: string,
      user: string,
      data: InlineObject2,
      options: any = {}
...
export const UsersApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async usersMeList(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Profiles>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.usersMeList(
        options
      );
      return createRequestFunction(
        localVarAxiosArgs,
     ...
     * @throws {RequiredError}
     */
    async usersProfilesClubsCreate(
      profile: string,
      user: string,
      data: InlineObject,
      options?: any
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ClubsWithDate>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.usersProfilesClubsCreate(
          profile,
          user,
          data,
          options
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.usersProfilesClubsDates(
          profile,
          uri,
          user,
          data,
    ...
    async usersProfilesClubsList(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<Array<ClubsWithDate>>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.usersProfilesClubsList(
          profile,
          user,
          options
        );
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.usersProfilesClubsRead(
          profile,
          uri,
          user,
          group,
     ...
     * @throws {RequiredError}
     */
    async usersProfilesEverytimeCreate(
      profile: string,
      user: string,
      data: InlineObject2,
      options?: any
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.usersProfilesEverytimeCreate(
          profile,
          user,
          data,
          options
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.usersProfilesRead(
          profile,
          user,
          options
        );
...
export const UsersApiFactory = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    usersProfilesClubsCreate(
      profile: string,
      user: string,
      data: InlineObject,
      options?: any
    ): AxiosPromise<ClubsWithDate> {
      return localVarFp
        .usersProfilesClubsCreate(profile, user, data, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    usersProfilesClubsDates(
      ...
      return localVarFp
        .usersProfilesClubsDates(profile, uri, user, data, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     * @throws {RequiredError}
     */
    usersProfilesClubsList(
      profile: string,
      user: string,
      options?: any
    ): AxiosPromise<Array<ClubsWithDate>> {
      return localVarFp
        .usersProfilesClubsList(profile, user, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    usersProfilesClubsRead(
      ...
      return localVarFp
        .usersProfilesClubsRead(profile, uri, user, group, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    usersProfilesEverytimeCreate(
      ...
      return localVarFp
        .usersProfilesEverytimeCreate(profile, user, data, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    usersProfilesRead(
      ...
      return localVarFp
        .usersProfilesRead(profile, user, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class UsersApi extends BaseAPI {
   ...
   * @memberof UsersApi
   */
  public usersProfilesClubsCreate(
    profile: string,
    user: string,
    data: InlineObject,
    options?: any
   ...
   * @memberof UsersApi
   */
  public usersProfilesClubsDates(
    profile: string,
    uri: string,
    user: string,
    data: InlineObject1,
   ...
   * @memberof UsersApi
   */
  public usersProfilesEverytimeCreate(
    profile: string,
    user: string,
    data: InlineObject2,
    options?: any
